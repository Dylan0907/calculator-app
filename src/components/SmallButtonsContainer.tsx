...
const SmallButtoncontainer = () => {
    ...
    return (
        <div className="grid grid-cols-4">
            ...
            <SmallButton text={'+'} keyStyle={selectedTheme.key} textStyle={selectedTheme.text} clickEvent={handleClickOperator}/>
            ...
            <SmallButton text={'-'} keyStyle={selectedTheme.key} textStyle={selectedTheme.text} clickEvent={handleClickOperator}/>
            <SmallButton text={'.'} keyStyle={selectedTheme.key} textStyle={selectedTheme.text} clickEvent={handleClickNumber}/>
            <SmallButton text={'0'} keyStyle={selectedTheme.key} textStyle={selectedTheme.text} clickEvent={handleClickNumber}/>
            <SmallButton text={'/'} keyStyle={selectedTheme.key} textStyle={selectedTheme.text} clickEvent={handleClickOperator}/>
            <SmallButton text={'x'} keyStyle={selectedTheme.key} textStyle={selectedTheme.text} clickEvent={handleClickOperator}/>
        </div>
    )
}
